 ...
 */
class UIDomConfigScene extends UTUIFrontEnd_CustomScreen;
...
event PostInitialize()
{
   ...
   NumOfTeams.SliderValue.MinValue = DomGameClass.Default.MinTeams;
   NumOfTeams.SliderValue.MaxValue = DomGameClass.Default.MaxTeams;
